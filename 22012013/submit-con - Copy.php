...
<br/> 
<br/>
I just got my eyes checked through the Titan Eye+ Online Eye Test.<br/> 
...
//header('Location: submit-con.php?err=1');
}else{
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=444020558966789";
...
<div class="main-body">
  ...
  <tr>
    <td align="center"><img src="images/results-logo.gif" /></td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td>
   <div class="store-box"><b class="thank"><?php echo $Dear1; ?> <?php include("name.php"); ?>,<br/> <?php echo $Thank_you_for_getting_your_eyes_checked1; ?><br/>
<?php echo $will_contact_you_shortly_to_fix_an_appointment1; ?><br/>
<?php echo $discount_offers_to_you1; ?> <br/>
<?php echo $continue_with_your_work1; ?></b> </div>
...
<?php } ?>
	...
	<br/>
	<div class="head-txt" ><?php echo $Recommend_this_eye_test1; ?></div>
	<br/>
	<form action="" method="post" name="subscriber" onsubmit="InitUnload();" ><div style="text-align:center;color:green;" ><?php  if($_REQUEST['err']==1){echo $Mail_has_been_sent_your_friends1;} ?></div><div id="Content">
	<div class="list1 listdiv"><?php echo $Res_Name1; ?> : <input type="text" name="name[]" value="" /> <?php echo $Res_Email_Id1; ?> : <input type="text" name="emailId[]" value="" />  <button id="Add" class="plus" /></button> </div>
 
<div style="padding-left:42px;" ><input type="submit" name="submit" id="submit" value="<?php echo $Res_Submit1; ?>"/> </div>
</div></form> </div>
